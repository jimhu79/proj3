App = {
    ...
    initWeb3: async function () {
        ...
        if (window.ethereum) {
            ...
            console.log("Web 3 Provider is Ethereum");
            try {
        ...
        // Legacy dapp browsers...
            ...
            console.log("Web 3 Provider is legacy dapp");
        }
        // If no injected web3 instance is detected, fall back to Ganache
        else {
            console.log("Web 3 Provider is Ganache");
    ...
    getMetamaskAccountID: function () {
        console.log("***In getMetamaskAccountID");
        web3 = new Web3(App.web3Provider);
    ...
    initSupplyChain: function () {
        console.log("***In initSupplyChain");
    ...
    addRoles: function(event) {
        ...
        App.contracts.SupplyChain.deployed().then(async function(instance) {
            await instance.addFarmer(App.originFarmerID);
    ...
    ///    var processId = parseInt($(event.target).data('id'));
        App.upc = $('#upc').val();
        console.log("***In fetchItemBufferOne");
    ...
    ///    event.preventDefault();
    ///    var processId = parseInt($(event.target).data('id'));
        console.log("***In fetchItemBufferTwo");
        App.contracts.SupplyChain.deployed().then(function(instance) {
